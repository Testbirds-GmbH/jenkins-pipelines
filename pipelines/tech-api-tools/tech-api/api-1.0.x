...
properties([
	...
	pipelineTriggers([
		[$class: 'GitLabPushTrigger', branchFilterType: "NameBasedFilter", includeBranchesSpec: "api-1.0.x", triggerOnPush: true, triggerOnMergeRequest: false, triggerOnNoteRequest: false],
		pollSCM('H/10 * * * *')
		])
	])
